...
export default class Faqhome extends React.Component{
    render(){
        return(
            <>
            <section className="faq-area faq-bg " data-background="img/bg/faq_bg.jpg"
            style={{'background-image': 'url("img/bg/faq_bg.jpg")'}}>
